...
// ── Renderers ───────────────────────────────────────────────────────────
export { renderToSVG, renderParagraphToSVG, renderResultToSVG } from './render/SVGRenderer.js';
export type { SVGRenderOptions, SvgPreset } from './render/SVGRenderer.js';
export { renderToCanvas, renderDebugToCanvas } from './render/CanvasRenderer.js';
export type { CanvasRenderOptions } from './render/CanvasRenderer.js';

// ── Render types (shared) ───────────────────────────────────────────────
export type { DebugFlags } from './types/RenderTypes.js';