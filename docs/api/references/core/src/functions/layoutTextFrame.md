...
> **layoutTextFrame**(`frame`): [`TextFrameLayoutResult`](../interfaces/TextFrameLayoutResult.md)

Defined in: [core/src/layout/TextFrameLayoutEngine.ts:119](https://github.com/sedrew/vyaz/blob/main/packages/core/src/layout/TextFrameLayoutEngine.ts#L119)
