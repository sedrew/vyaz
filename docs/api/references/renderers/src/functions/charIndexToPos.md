[vyaz-monorepo](../../../index.md) / [renderers/src](../index.md) / charIndexToPos

# Function: charIndexToPos()

> **charIndexToPos**(`lines`, `charIndex`): [`CharPos`](../interfaces/CharPos.md) \| `null`

Defined in: [renderers/src/interactive.ts:214](https://github.com/sedrew/vyaz/blob/main/packages/renderers/src/interactive.ts#L214)
