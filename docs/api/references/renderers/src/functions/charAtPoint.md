[vyaz-monorepo](../../../index.md) / [renderers/src](../index.md) / charAtPoint

# Function: charAtPoint()

> **charAtPoint**(`lines`, `px`, `py`): [`CharPos`](../interfaces/CharPos.md) \| `null`

Defined in: [renderers/src/interactive.ts:129](https://github.com/sedrew/vyaz/blob/main/packages/renderers/src/interactive.ts#L129)
